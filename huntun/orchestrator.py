...
class AgentRuntime:
    ...
    def info(self) -> dict[str, Any]:
        ...
        return {
            "backend": b,
            "model": spec.model or cfg.model or ("claude-opus-5-5" if b == "api" else "Codex default" if b == "codex" else "Kimi default" if b == "kimi" else "DeepSeek default" if b == "deepseek" else "Ollama default" if b == "ollama" else "vLLM default" if b == "vllm" else "Claude Code default"),
